view: t_zagent_smu_voice {
  sql_table_name: `es-s2dl-core-p.emc.t_zagent_smu_voice`
    ;;
  ...
  measure: count {
    type: count
    drill_fields: [id, analysis_name, sessionname]
  }
}

view: t_zagent_smu_voice__reasonscodes {
  dimension: packetids {
    type: string
    sql: ${TABLE}.packetids ;;
  }
...
view: t_zagent_smu_voice__paramlist {
  dimension: key {
    type: string
    sql: ${TABLE}.Key ;;
  }
